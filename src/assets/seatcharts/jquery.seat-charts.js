...
(function($) {
	...
	$.fn.seatCharts = function (setup) {
			...
			seat = (function(seatCharts, seatChartsSettings) {
				return function (setup) {
					...
					fn.settings.$node
						...
						//.text(fn.settings.label) comentado por que aqui é o label do assento
            .text('')
						.addClass(['seatCharts-seat', 'seatCharts-cell', 'available', 'zoomTarget level1'].concat(
                  ...
                  // ajuste para o modal acompanahar a cor do btn preto
                  let sta = '';
                  if(fn.settings.data.classes == "economy-class") {
                    sta = 'economy'; 
                  } else {
                    sta = fn.settings.status;
                  }
								}
      ...
      // quando o usuario tentava arastar a tela voltava para o topo
